...
public class CharthiedorV2 extends AdvancedRobot 
{
    ...
    {      	
        ...
        while(true) 
        {
			...
			// Si on à fait un tour complet sans avoir scanné ou heurté un ennemi, on bouge
    ...
    public void onScannedRobot(ScannedRobotEvent e) 
    {
        ...
        compteurNbDegre = 0;// Mise à zero du compteur puisque l'on a scanné quelqu'un
    ...
    {
    	compteurNbDegre = 0;// Mise à zero du compteur puisque l'on a heurté quelqu'un
